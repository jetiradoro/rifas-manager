<template>
  <q-form @submit="onSubmit" class="q-gutter-md">
    <q-input v-model="form.name" label="Nombre" outlined :rules="[(val) => !!val || 'El nombre es obligatorio']">
    ...
    <div class="row justify-end q-gutter-sm">
      ...
      <q-btn type="submit" label="Guardar Cambios" color="primary" :loading="loading" :disable="!hasChanges" />
    </div>
  </q-form>
</template>
